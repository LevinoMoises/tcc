...
respectivamente.
  ...
  existência do Java \cite{java} na máquina de desenvolvimento. Visto que todas
  as plataformas utilizadas nesse projeto necessitam dessa tecnologia base.

  Após a verificação da existência do Java, segui-se os passos disponíveis para a
  configuração do AMUSE. Tais passos estão disponíveis no tutorial de
